odoo.define('ppts_documents_customize', function(require) {
'use strict';
...
website_sign = website_sign.include({
	...
	createSignatureItem: function(type, required, responsible, posX, posY, width, height, value, name) {
            ...
            var $signatureItem = $(core.qweb.render('ppts_documents_customize.signature_item', {
...
odoo.define('ppts_documents_customize.Document', function (require) {
